...
<body>
    <div class="big-div">
        <div class="tela-parte1">
            <img src="assets/logoo.jpeg" alt="Logo Ester Acessórios" class="img-logo-form">
            <h1 class="bem-vindo">Seja bem vindo!</h1>
        </div>
        <div class="tela-parte2">
            ...
            <form action="cadastrarAdm.php" method="POST" class="form">
                ...
                <div class="input-icon">
                    ...
                    <input type="email" id="email" name="email" placeholder="Ex: ana@gmail.com" class="inputs-form">
                </div>
                ...
                <div class="input-icon">
                    ...
                    <input type="password" id="senha" name="senha" placeholder="Digite sua senha" class="inputs-form">
                </div>
